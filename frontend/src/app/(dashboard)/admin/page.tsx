...
const usersList = [
  {
    ...
    role: "Administrador",
    status: "Activo",
    statusColor: "bg-[#D1FAE5] dark:bg-[#064E3B]/50 text-[#065F46] dark:text-[#34D399]",
  },
  {
    name: "Carlos Méndez",
  ...
  },
  {
    ...
    role: "Seguridad",
    status: "Inactivo",
    statusColor: "bg-[#F1F5F9] dark:bg-[#1E293B] text-[#64748B] dark:text-[#94A3B8]",
  },
];
    ...
    <div className="p-8 bg-[#F8FAFC] dark:bg-[#0B0F19] min-h-screen transition-colors">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-[#0F172A] dark:text-white">Configuración del Sistema</h1>
        ...
        <div className="flex items-center gap-2 border-b border-[#E2E8F0] dark:border-[#1E293B] pb-2 overflow-x-auto">
          <button className="px-4 py-2 bg-[#2563EB] text-white text-xs font-semibold rounded-xl shadow-sm">
            Gestión de Usuarios
          </button>
          <button className="px-4 py-2 bg-white dark:bg-[#111827] border border-[#E2E8F0] dark:border-[#1E293B] hover:bg-[#F8FAFC] dark:hover:bg-[#1E293B] text-[#64748B] dark:text-[#94A3B8] text-xs font-semibold rounded-xl transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-[#111827] rounded-2xl border border-[#E2E8F0] dark:border-[#1E293B] shadow-sm p-6 space-y-4 transition-colors">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-[#F1F5F9] dark:border-[#1E293B] pb-4">
              <div>
                <h2 className="text-base font-bold text-[#0F172A] dark:text-white">Usuarios Registrados</h2>
                <p className="text-xs text-[#64748B] dark:text-[#94A3B8]">Personal con acceso a la plataforma</p>
              </div>

              <input
                type="text"
                placeholder="Buscar por nombre o email..."
                className="w-full sm:w-56 bg-[#F8FAFC] dark:bg-[#1E293B] border border-[#E2E8F0] dark:border-transparent text-xs rounded-xl px-3 py-2 text-[#0F172A] dark:text-white placeholder-[#94A3B8] outline-none focus:border-[#2563EB]"
              />
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-[#F1F5F9] dark:divide-[#1E293B] text-xs text-[#475569] dark:text-[#CBD5E1]">
                  {usersList.map((user) => (
                    <tr key={user.email} className="hover:bg-[#F8FAFC] dark:hover:bg-[#1E293B]/50 transition-colors">
                      <td className="py-3.5 px-3">
                        <div>
                          <p className="font-bold text-[#0F172A] dark:text-white">{user.name}</p>
                      ...
                      <td className="py-3.5 px-3 text-right space-x-2">
                        ...
                        <button className="text-xs font-semibold text-[#EF4444] dark:text-[#F87171] hover:underline">
                          Eliminar
                        </button>
                      </td>
                    </tr>
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-[#111827] rounded-2xl border border-[#E2E8F0] dark:border-[#1E293B] shadow-sm p-6 space-y-4 transition-colors">
              <div className="border-b border-[#F1F5F9] dark:border-[#1E293B] pb-3 flex items-center justify-between">
                <h2 className="text-base font-bold text-[#0F172A] dark:text-white">Ajustes de IA (RAG)</h2>
                <span className="text-xs text-[#2563EB] dark:text-[#60A5FA] font-bold">Configuración</span>
              </div>
              ...
              <div className="space-y-4 text-xs">
                <div>
                  ...
                  <select className="w-full bg-[#F8FAFC] dark:bg-[#1E293B] border border-[#E2E8F0] dark:border-transparent text-xs rounded-xl p-2.5 text-[#0F172A] dark:text-white outline-none">
                ...
                <div>
                  ...
                  <div className="flex justify-between text-[10px] text-[#94A3B8] mt-0.5">
                    ...
                    <span className="font-bold text-[#2563EB] dark:text-[#60A5FA]">80%</span>
                ...
                <div className="pt-2 border-t border-[#F1F5F9] dark:border-[#1E293B] space-y-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    <span className="font-medium text-[#0F172A] dark:text-white">Auto-clasificar área al crear ticket</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" defaultChecked className="rounded text-[#2563EB] focus:ring-0" />
                    <span className="font-medium text-[#0F172A] dark:text-white">Generar sugerencias de solución RAG</span>
                  </label>
                </div>
